...
{
    public partial class FrmPageHistoryAlarm : Form
    {
        public FrmPageHistoryAlarm()
        {
            InitializeComponent();
            SetBounds(0, 0, 1790, 998);
        }

        private void FormPageHistoryAlarm_Load(object sender, EventArgs e)
        {
        ...
        private void FormPageHistoryAlarm_VisibleChanged(object sender, EventArgs e)
        {
            if(Visible)
            {
                String Temp = "";
                ...
                int Count = cDEF.Run.Log.Alarm.Count;
        ...
        {
            lbTitle.Text = cDEF.Lang.Trans("ALARM");
        }
    }
}
