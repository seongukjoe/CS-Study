...
{
    public partial class FrmPageHistoryWarning : Form
    {
        public FrmPageHistoryWarning()
        {
            InitializeComponent();
            SetBounds(0, 0, 1790, 998);
        }

        private void FrmPageHistoryWarning_Load(object sender, EventArgs e)
        {
        ...
        private void FrmPageHistoryWarning_VisibleChanged(object sender, EventArgs e)
        {
            if (Visible)
            {
                String Temp = "";
                ...
                int Count = cDEF.Run.Log.Warning.Count;
        ...
        {
            lbTitle.Text = cDEF.Lang.Trans("WARNING");
        }
    }
}
